...
**Objects:** This category presents a list of specific objects that are grouped together within the asset. In the case of blob storage, such as S3, each object entry is accompanied by a console link, granting you the ability to further investigate and explore these objects within your account's console.
