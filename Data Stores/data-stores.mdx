...
import overviewPage from '@site/static/assets/overview-page.png';
...
- **Name:** The identifier assigned to the data store.

- **Account:** The associated account or owner of the data store.

- **Region:** The geographical location where the data store is hosted or deployed.

- **Size:** The allocated resources or capacity of the data store.

- **Database Engine:** The specific database management system used by the data store.

- **Hosting Service:** The service or platform utilized to host or deploy the data store.

- **Category:** The classification or categorization of the data store based on its characteristics or purpose.

- **Managed:** Indicates whether the data store is managed or requires manual administration.

- **Age since creation:** The time since the data store was initially created.

- **Classification:** Additional categorization or labeling based on specific criteria or attributes.

- **Security properties:** Information regarding the data stores security measures, including whether it is publicly accessible, supports logging, backup functionality, or encryption.

- **Networking:** The data stores network configuration and connectivity details.

- **Tags:** Cloud-based user defined labels or metadata assigned to the data store for organizational or identification purposes.

- **Open in Console:** Upon clicking this option, the user is redirected to the cloud providerinstance of the selected data store.
